...
const PROSPECT = {
  name: "Sue",
  company: "ADinfinitum",
  companyDetail: "Purpose-driven PR & brand communications agency, 30+ years in business",
  industry: "PR & Brand Communications",
  teamSize: "~6",
  painNumber: "60–110",
  painPercent: "65",
  ...
  specifics: [
    "30+ years in natural & wellness PR — clients include Naturepedic, EarthKind, Hooray Foods, Trilogy, and Kyowa Hakko",
    "1% for the Planet member — commits agency revenue to environmental partners",
    "Generated 50M+ impressions during Naturepedic COVID face mask campaign pivot",
    "HQ at 7 World Trade Center — working with purpose-driven brands from startups to NGOs",
  ],

  competitors: {
    line: "66% of PR professionals now use AI frequently in their work",
    detail: "Coyne PR integrated OpenAI in 2022 and now leads in Generative Engine Optimization. Grasslands uses content-creator marketing at scale. 5W PR uses Meltwater and Brandwatch AI dashboards for real-time media monitoring.",
    source: "USC/Institute for PR 2024",
  },

  automations: [
    {
      title: "Media Monitoring Agent",
      desc: "Real-time coverage tracking across news, wellness publications, podcasts, and social media for all your clients — with intelligent relevance scoring tuned to natural products and sustainability verticals.",
      before: { value: "Hours / Days", sub: "to detect coverage" },
      after: { value: "Minutes", sub: "real-time detection" },
      flow: [
        { label: "News & Media Feeds", icon: "📡" },
        { label: "AI Monitoring Agent", icon: "🧠" },
        { label: "Smart Alerts & Briefs", icon: "⚡" },
      ],
      color: "#3b82f6",
      saved: "10–18 hrs/wk",
    },
    {
      title: "Pitch & Press Release Agent",
      desc: "Generates tailored pitches and press releases in each client's unique brand voice — referencing journalist preferences, past coverage, and the latest wellness industry angles.",
      before: { value: "2–3 hrs", sub: "per pitch from scratch" },
      after: { value: "15 min", sub: "review & polish" },
      flow: [
        { label: "Client Briefs & Data", icon: "📋" },
        { label: "AI Writing Agent", icon: "🧠" },
        { label: "Ready-to-Send Pitches", icon: "✍️" },
      ],
      color: "#f59e0b",
      saved: "12–20 hrs/wk",
    },
    {
      title: "Influencer & Media Discovery Agent",
      desc: "Scans wellness, natural product, and sustainability verticals to find journalists, editors, podcasters, and influencers aligned with each client's mission and values.",
      before: { value: "4–6 hrs", sub: "manual research per campaign" },
      after: { value: "Minutes", sub: "curated shortlists" },
      flow: [
        { label: "Industry & Social Data", icon: "🌐" },
        { label: "AI Research Agent", icon: "🔍" },
        { label: "Ranked Contact Lists", icon: "📄" },
      ],
      color: "#10b981",
      saved: "8–15 hrs/wk",
    },
    {
      ...
      desc: "Automatically compiles media coverage, impressions, sentiment, and ROI metrics into polished monthly reports — so your team spends time on strategy, not spreadsheets.",
      before: { value: "Full Day", sub: "per client report" },
      after: { value: "Auto-Generated", sub: "drafts ready to review" },
      flow: [
        { label: "Coverage & Analytics", icon: "📊" },
        { label: "AI Reporting Agent", icon: "🧠" },
        { label: "Client-Ready Reports", icon: "📈" },
      ],
      color: "#a855f7",
      saved: "10–18 hrs/wk",
    },
        ...
        <div style={{
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 10 }}>
              {[
                { v: 350, s: "+", p: "", sub: "hours of manual work", c: "#fca5a5" },
        ...
        <div style={{
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
              {[
                { v: 55, s: " hrs", p: "~", sub: "freed up every week" },
                { v: 330, s: "K", p: "$", sub: "in reclaimed capacity" },
