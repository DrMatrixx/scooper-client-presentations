...
const PROSPECT = {
  name: "Joanna",
  company: "NutriGap",
  companyDetail: "Swedish femtech platform — AI-powered nutrition for fertility, pregnancy & women's health",
  industry: "Femtech / Digital Health",
  teamSize: "~6",
  painNumber: "30–60",
  painPercent: "60",
  ...
  competitors: {
    line: "The femtech market hit $60.9B in 2025 — growing 16.4% annually",
    detail: "Flo has 380M users with AI-powered fertility tracking. Clue earns $35M/year with predictive cycle analytics. Natural Cycles is FDA-cleared with AI-based contraception. All are investing heavily in AI personalization.",
    source: "Grand View Research 2025",
  },
  automations: [
    {
      title: "Nutrition Analysis & Recommendations Agent",
      desc: "An AI agent that analyzes food diary entries, blood test results, and symptom logs to generate personalized nutrition plans at scale — extending your dietitian expertise to every user without adding headcount, with automatic flagging when values fall outside optimal fertility ranges.",
      before: { value: "30–45 min", sub: "per patient analysis" },
      after: { value: "Instant insights", sub: "dietitian reviews flags" },
      flow: [
        { label: "Food & Blood Data", icon: "📊" },
        { label: "AI Analysis Agent", icon: "🧠" },
        { label: "Personal Nutrition Plan", icon: "⚡" },
      ],
      color: "#3b82f6",
      saved: "10–20 hrs/wk",
    },
    {
      title: "Content & Education Agent",
      desc: "An AI agent that creates evidence-based nutrition articles, social media content, app notifications, and patient education materials in Swedish and English — keeping users engaged while building NutriGap's authority in fertility nutrition.",
      before: { value: "4–6 hrs", sub: "per content piece" },
      after: { value: "30 min review", sub: "AI drafts & localizes" },
      flow: [
        { label: "Research & Brand Data", icon: "📡" },
    ...
    {
      title: "B2B Lead & Partnership Agent",
      desc: "An AI agent that identifies and qualifies clinics, insurance companies, and corporate wellness programs as potential partners — researching their fertility and wellness offerings, drafting personalized outreach, and tracking engagement across your B2B pipeline.",
      before: { value: "Manual research", sub: "hours per lead" },
      after: { value: "AI-qualified leads", sub: "ready-to-send outreach" },
      flow: [
        { label: "Clinic & Insurer Data", icon: "🌐" },
        { label: "AI Prospecting Agent", icon: "🧠" },
        { label: "Qualified Leads & Drafts", icon: "📄" },
      ],
      color: "#10b981",
      saved: "5–12 hrs/wk",
    },
    {
      title: "Customer Support & Onboarding Agent",
      desc: "An AI agent that guides new users through app setup, blood test ordering, and supplement selection — answering questions about nutrition protocols, fertility support, and product usage while escalating medical queries to your dietitian team.",
      before: { value: "15–20 min", sub: "per support query" },
      after: { value: "Instant guidance", sub: "85% auto-resolved" },
      flow: [
        { label: "User Questions", icon: "💬" },
        ...
        <div style={{
          ...
          <div style={{ position: "relative" }}>
            ...
            <p style={{ color: "#555", fontSize: 11, marginTop: 16, lineHeight: 1.5 }}>
              Femtech platforms that start building this advantage now will be increasingly difficult to catch.
            </p>
          </div>
        </div>
      </section>
        ...
        <div style={{
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
              {[
                { v: 46, s: " hrs", p: "~", sub: "freed up every week" },
                { v: 270, s: "K", p: "$", sub: "in reclaimed capacity" },
                { v: 2, s: "–3x", p: "", sub: "more users without new hires" },
              ].map((m, i) => (
