...
const PROSPECT = {
  name: "Haley",
  company: "Consumer Product Events",
  companyDetail: "DIY PR matchmaker for CPG brands, 15+ years connecting products with press",
  industry: "PR & Events",
  teamSize: "~5",
  painNumber: "35–60",
  painPercent: "65",
  annualCost: "200K–350K",
  specifics: [
    "1,200+ brands served since 2009 including Tesla, Adidas, Mattel, Kraft, KitchenAid, Starbucks",
    "Goldman Sachs 10,000 Small Businesses alumni (2020), Forbes Business Council member",
    "Events in NYC and LA — brands meet 50+ press contacts face-to-face in a single day",
    "Women-owned business (WBE certified), founded by 30-year CPG publicist Alyson Dutch",
  ],
  competitors: {
    line: "88% of organizations now use AI in at least one business function",
    detail: "Cision uses AI-powered journalist recommendations. Muck Rack offers AI media monitoring. Propel has AI-driven pitching and analytics. PR firms of all sizes are adopting AI for media matching.",
    source: "McKinsey 2025",
  },
  automations: [
    {
      title: "Media Contact Intelligence Agent",
      desc: "An AI agent that continuously monitors journalists' recent coverage, beat changes, and social activity — auto-generating fresh, scored media lists tailored to each event across your 200+ contact database.",
      before: { value: "8–10 hrs", sub: "manual list curation" },
      after: { value: "Auto-updated", sub: "scored & prioritized" },
      flow: [
        { label: "News & Social Feeds", icon: "📡" },
        { label: "AI Contact Scoring", icon: "🧠" },
        { label: "Targeted Media Lists", icon: "📋" },
      ],
      color: "#3b82f6",
      saved: "5–10 hrs/wk",
    },
    {
      title: "Brand Application Screening Agent",
      desc: "An AI agent that evaluates incoming brand applications for your NYC and LA events — reads their website, assesses product-market fit, checks press readiness, and delivers a ranked shortlist so your team reviews only the best matches.",
      before: { value: "Manual", sub: "review per application" },
      after: { value: "AI-ranked", sub: "top matches surfaced" },
      flow: [
        { label: "Brand Applications", icon: "📧" },
        { label: "AI Fit Scoring Agent", icon: "🧠" },
        { label: "Ranked Shortlist", icon: "✅" },
      ],
      color: "#f59e0b",
      saved: "3–8 hrs/wk",
    },
    {
      title: "Press Kit Generation Agent",
      desc: "An AI agent that drafts complete press kits — fact sheets, backgrounders, releases, and bios — from brand materials in minutes. Your team reviews and polishes instead of writing from scratch, handling more of your 1,200+ brand clients without more hours.",
      before: { value: "4–6 hrs", sub: "per kit from scratch" },
      after: { value: "30 min review", sub: "AI-drafted & formatted" },
      flow: [
        { label: "Brand Materials", icon: "📝" },
        { label: "AI Writing Agent", icon: "🧠" },
        { label: "Ready Press Kits", icon: "📄" },
      ],
      color: "#10b981",
      saved: "8–15 hrs/wk",
    },
    {
      title: "Post-Event Outreach Agent",
      desc: "After each event, an AI agent drafts personalized follow-up pitches for every brand-journalist match made — referencing specific conversations and interests from the day. It tracks responses and schedules follow-ups automatically.",
      before: { value: "Days", sub: "to follow up 50+ matches" },
      after: { value: "Same day", sub: "personalized at scale" },
      flow: [
        { label: "Event Match Data", icon: "🗂️" },
        { label: "AI Outreach Agent", icon: "🧠" },
        ...
        <div style={{
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 10 }}>
              {[
                { v: 200, s: "+", p: "", sub: "hours of manual work", c: "#fca5a5" },
            ...
            <p style={{ color: "#555", fontSize: 11, marginTop: 16, lineHeight: 1.5 }}>
              Event companies that start building this advantage now will be increasingly difficult to catch.
            </p>
          </div>
        </div>
      </section>
        ...
        <div style={{
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
              {[
                { v: 32, s: " hrs", p: "~", sub: "freed up every week" },
