  ...
  slides: [
    {
      ...
      render: () => (
        <div className="text-center w-full max-w-2xl px-4">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-bold text-white mb-3 sm:mb-4">HOS Reality</h1>
          <p className="text-base sm:text-lg md:text-xl text-gray-400 mb-4 sm:mb-6">Operational Transformation Through <GradientText>Intelligent Automation</GradientText></p>
          <div className="w-24 sm:w-32 h-0.5 bg-gradient-to-r from-amber-500 to-orange-500 mx-auto mb-6 sm:mb-8" />
          <p className="text-gray-500 text-xs sm:text-sm max-w-lg mx-auto">A strategic proposal to automate lead management, client communications, documentation, and internal operations — reducing manual workload while increasing conversion and revenue.</p>
        </div>
      ),
    },
    {
