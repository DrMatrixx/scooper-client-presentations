...
const PROSPECT = {
  name: "Leo",
  company: "Supernormal",
  companyDetail: "Swedish digital health platform — GLP-1 medical weight loss, coaching, testing & supplements",
  industry: "Digital Health",
  teamSize: "~16",
  painNumber: "80–150",
  painPercent: "60",
  annualCost: "400K–700K",

  competitors: {
    line: "85% of healthcare leaders are now exploring or have adopted generative AI",
    detail: "Noom uses AI coaching to manage 300+ patients per coach. Yazen raised €19.5M and has 37,000+ active patients with wraparound care. Calibrate and Ro are scaling GLP-1 programs with AI-driven personalization.",
    source: "McKinsey 2024",
  },
  automations: [
    {
      title: "Patient Intake & Qualification Agent",
      desc: "An AI agent that screens new patient applications, verifies BMI eligibility, collects medical history, and prepares complete profiles for physician review — reducing intake from hours to minutes across your nationwide patient base.",
      before: { value: "45–60 min", sub: "per patient intake" },
      after: { value: "5 min review", sub: "AI pre-screens everything" },
      flow: [
        { label: "Patient Applications", icon: "📋" },
        { label: "AI Screening Agent", icon: "🧠" },
        { label: "Ready Physician Profile", icon: "✅" },
      ],
      color: "#3b82f6",
      saved: "15–25 hrs/wk",
    },
    {
      title: "Patient Coaching & Follow-up Agent",
      desc: "An AI agent that monitors patient progress across weight, medication adherence, and lifestyle changes — sending personalized check-ins, adjusting coaching recommendations, and flagging patients who need physician attention before they disengage.",
      before: { value: "20–30 min", sub: "per patient check-in" },
      after: { value: "Auto-managed", sub: "human review for flags" },
      flow: [
        { label: "Patient Data & Logs", icon: "📊" },
        { label: "AI Coaching Agent", icon: "🧠" },
        { label: "Personalized Updates", icon: "⚡" },
      ],
      color: "#f59e0b",
      saved: "20–35 hrs/wk",
    },
    {
      ...
      desc: "An AI agent that creates patient success stories, social content, blog posts, and ad copy tailored to Supernormal's brand — in both Swedish and English — while optimizing campaigns using conversion data from your existing TikTok, Facebook, and Google stack.",
      before: { value: "4–6 hrs", sub: "per content piece" },
      after: { value: "30 min review", sub: "AI drafts & localizes" },
      flow: [
        { label: "Brand & Analytics Data", icon: "📡" },
        { label: "AI Content Agent", icon: "🧠" },
        { label: "Multi-Channel Content", icon: "✍️" },
      ],
      color: "#10b981",
      saved: "10–20 hrs/wk",
    },
    {
      title: "Medication Dosing & Reorder Agent",
      desc: "An AI agent that tracks patient medication schedules, monitors GLP-1 titration progress, alerts physicians when dosing adjustments are needed, and automates prescription renewal reminders — ensuring no patient falls through the cracks.",
      before: { value: "Manual tracking", sub: "across patient base" },
      after: { value: "Automated alerts", sub: "zero missed renewals" },
      flow: [
        { label: "Rx & Patient Records", icon: "🗂️" },
        { label: "AI Dosing Agent", icon: "🧠" },
        { label: "Physician Alerts", icon: "🔔" },
      ],
      color: "#a855f7",
      saved: "10–15 hrs/wk",
    },
    {
      ...
      desc: "An AI agent that handles incoming patient questions via Intercom, resolves common inquiries about treatment plans, insurance reimbursement, and supplement orders instantly — and escalates medical concerns to the right team member.",
      before: { value: "15–20 min", sub: "per support ticket" },
      after: { value: "Instant response", sub: "80% auto-resolved" },
      flow: [
        { label: "Intercom Messages", icon: "💬" },
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 10 }}>
              {[
                ...
                { v: 45, s: "K+", p: "$", sub: "in opportunity cost", c: "#fca5a5" },
            ...
            <p style={{ color: "#555", fontSize: 11, marginTop: 16, lineHeight: 1.5 }}>
              Health platforms that start building this advantage now will be increasingly difficult to catch.
            </p>
          </div>
        </div>
      </section>
        ...
        <div style={{
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
              {[
                { v: 90, s: " hrs", p: "~", sub: "freed up every week" },
                { v: 540, s: "K", p: "$", sub: "in reclaimed capacity" },
                { v: 2, s: "–3x", p: "", sub: "more patients without new hires" },
              ].map((m, i) => (
