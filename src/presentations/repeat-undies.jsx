...
const PROSPECT = {
  name: "Florian",
  company: "REPEAT",
  companyDetail: "Self-funded period underwear brand, 1M+ products sold, 300K+ customers across 4 markets",
  industry: "DTC Period Underwear",
  teamSize: "~3",
  painNumber: "40–80",
  painPercent: "65",
  annualCost: "200K–400K",
  competitors: {
    line: "84% of ecommerce businesses are integrating AI or plan to by end of 2025",
    detail: "Thinx uses AI-powered customer service and personalized recommendations. Modibodi automates retention marketing at scale. Savage X Fenty deploys AI virtual fitting to reduce returns. 3-person teams without AI can't compete at this scale.",
    source: "Shopify 2025",
  },
  automations: [
    {
      title: "Multi-Language Customer Service Agent",
      desc: "An AI agent that handles order tracking, returns, sizing questions, and product info in French, English, and German — 24/7 across all four REPEAT storefronts. Escalates complex cases with full context so the three of you only handle what matters.",
      before: { value: "8–12 hrs/wk", sub: "across 4 markets, 3 languages" },
      after: { value: "80% auto", sub: "resolved in seconds, any language" },
      flow: [
        { label: "Customer Inquiries", icon: "📧" },
        { label: "AI Support Agent", icon: "🧠" },
        { label: "Auto-Resolved / Routed", icon: "⚡" },
      ],
      color: "#3b82f6",
      saved: "8–15 hrs/wk",
    },
    {
      title: "Cycle-Predicted Retention & Reorder Agent",
      desc: "Period underwear has a natural replacement cycle. An AI agent analyzes purchase history and product lifespan to predict when each customer needs new pairs — then triggers personalized reorder nudges, bundle offers, and win-back campaigns via Klaviyo.",
      before: { value: "Generic blasts", sub: "same email to everyone" },
      after: { value: "Cycle-timed", sub: "personalized reorder nudges" },
      flow: [
        { label: "Purchase History", icon: "📊" },
        { label: "AI Retention Agent", icon: "🧠" },
        { label: "Timed Campaigns", icon: "📬" },
      ],
      color: "#f59e0b",
      saved: "5–10 hrs/wk",
    },
    {
      title: "Multi-Market Content & Social Agent",
      desc: "Three founders managing social, UGC, and content across France, UK, Germany, and Europe is unsustainable at scale. An AI agent generates localized content drafts, collects and curates UGC, and schedules posts — in each market's language and tone.",
      before: { value: "5–8 hrs/wk", sub: "manual content per market" },
      after: { value: "AI-drafted", sub: "localized content in minutes" },
      flow: [
        { label: "Brand Assets & UGC", icon: "📱" },
        { label: "AI Content Agent", icon: "🧠" },
        { label: "Localized Posts", icon: "✍️" },
      ],
      color: "#10b981",
      saved: "5–10 hrs/wk",
    },
    {
      title: "Smart Size & Product Recommendation Agent",
      desc: "Sizing is the #1 friction point for underwear online. An AI-powered guide on your Shopify storefront that asks about flow level, body type, and style preference — then recommends the perfect product. Cuts returns, boosts conversion, builds confidence.",
      before: { value: "Static FAQ", sub: "customers guess their size" },
      after: { value: "Smart fit guide", sub: "personalized recommendations" },
      flow: [
        { label: "Customer Preferences", icon: "📋" },
        { label: "AI Recommendation Agent", icon: "🧠" },
        { label: "Perfect Match", icon: "🎯" },
      ],
      color: "#a855f7",
      saved: "3–6 hrs/wk",
    },
    {
      title: "Cross-Market Inventory & Ops Agent",
      desc: "Managing stock across four Shopify stores (FR, UK, DE, EU) manually is a recipe for stockouts and oversupply. An AI agent syncs inventory in real time, forecasts demand per market by season, and flags reorder points before you run out.",
      before: { value: "Manual tracking", sub: "across 4 Shopify stores" },
      after: { value: "Auto-synced", sub: "demand-predicted per market" },
      flow: [
        { label: "Multi-Store Data", icon: "🗂️" },
        { label: "AI Inventory Agent", icon: "🧠" },
        { label: "Smart Stock Alerts", icon: "📈" },
      ],
      color: "#ec4899",
      saved: "4–8 hrs/wk",
    },
      ...
      <section ref={heroRef} style={{
        ...
        <div style={{ position: "relative", maxWidth: 560 }}>
          ...
          <h1 style={{ ...tr(heroVis, 0.1), fontSize: "clamp(28px, 6.5vw, 50px)", fontWeight: 900, lineHeight: 1.1, margin: "0 0 16px" }}>
            <span style={{ color: "#fff" }}>Florian, 3 founders running</span><br />
            <span style={{ background: "linear-gradient(135deg, #f43f5e, #ec4899)", WebkitBackgroundClip: "text", WebkitTextFillColor: "transparent" }}>4 markets</span><br />
            <span style={{ color: "#fff" }}>is a scaling problem AI solves.</span>
          </h1>

          <p style={{ ...tr(heroVis, 0.22), color: "#555", fontSize: 14, lineHeight: 1.7, maxWidth: 440, margin: "0 auto 20px" }}>
            You, Anjali, and Jonathan built an 8-figure brand from nothing — 1M+ products sold, 300K+ customers, Forbes 30 Under 30. But {PROSPECT.painNumber} hrs/week still goes to ops, CS, and content across FR, UK, DE, and EU. We found {PROSPECT.automations.length} automations that could reclaim that time — worth an estimated <span style={{ color: "#fbbf24", fontWeight: 700 }}>${PROSPECT.annualCost}/year</span>.
          </p>
        ...
        <div style={{
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 10 }}>
              {[
                { v: 250, s: "+", p: "", sub: "hours of manual work", c: "#fca5a5" },
        ...
        <div style={{
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
              {[
                { v: 35, s: " hrs", p: "~", sub: "freed up every week" },
                { v: 200, s: "K", p: "$", sub: "in reclaimed capacity" },
                { v: 2, s: "–3x", p: "", sub: "scale without new hires" },
              ].map((m, i) => (
