...
const PROSPECT = {
  name: "Laurel",
  company: "Daily Crunch Snacks",
  companyDetail: "Sprouted nut snack brand, ~18-person team, 16,500+ retail locations",
  industry: "CPG / Snack Brand",
  teamSize: "~18",
  painNumber: "31–49",
  painPercent: "60",
  annualCost: "300K–600K",
  competitors: {
    line: "74% of CPG companies now use AI in at least one business function",
    detail: "KIND uses AI for demand forecasting and retail optimization. RXBAR automates influencer outreach at scale. Pipcorn and lesser-known DTC brands are adopting AI-powered Klaviyo flows and Shopify automations to compete with legacy players.",
    source: "McKinsey 2024",
  },
  automations: [
    {
      title: "Wholesale Lead Capture & Qualification Agent",
      desc: "Retail buyer inquiries from your website, Faire, and trade shows are automatically classified by retailer type, scored by store count and regional fit, and responded to in under 5 minutes — so your sales team gets qualified leads with full context, not cold inbox messages.",
      before: { value: "12–48 hrs", sub: "lead response time" },
      after: { value: "< 5 min", sub: "instant qualification" },
      flow: [
        { label: "Website & Faire Leads", icon: "📡" },
        { label: "AI Qualification Agent", icon: "🧠" },
        { label: "Scored & Scheduled", icon: "🎯" },
      ],
      color: "#3b82f6",
      saved: "8–12 hrs/wk",
    },
    {
      title: "DTC Customer Inquiry Auto-Response Agent",
      desc: "AI-powered triage that auto-resolves common issues — shipping status, subscription changes, dietary info — and escalates complex cases with full context. Your team focuses on high-value interactions only. Plugs directly into Shopify order data.",
      before: { value: "5–8 hrs/wk", sub: "manual email responses" },
      after: { value: "80% auto", sub: "resolved without team" },
      flow: [
    ...
    {
      title: "Order Processing & Fulfillment Agent",
      desc: "A unified order pipeline that auto-validates orders from Shopify, Faire, and Amazon, syncs inventory in real time across 16,500+ retail points, and routes fulfillment — reducing order-to-ship time from hours to minutes with zero manual data entry.",
      before: { value: "2–4 hrs/day", sub: "manual processing" },
      after: { value: "Minutes", sub: "auto-routed fulfillment" },
      flow: [
        { label: "Multi-Channel Orders", icon: "📋" },
        { label: "AI Fulfillment Agent", icon: "🧠" },
        { label: "Routed & Shipped", icon: "✅" },
      ],
      color: "#10b981",
      saved: "10–15 hrs/wk",
    },
    {
      title: "Customer Retention & Reorder Engine",
      desc: "Proactive retention that analyzes purchase cycles, identifies churn risk from engagement signals, and triggers personalized Klaviyo campaigns — reorder nudges, subscription upgrades, and win-back sequences — increasing lifetime value without manual outreach.",
      before: { value: "Reactive", sub: "customers churn silently" },
      after: { value: "Predictive", sub: "behavior-driven triggers" },
      flow: [
        { label: "Purchase & Engagement", icon: "📊" },
        { label: "AI Retention Agent", icon: "🧠" },
        { label: "Personalized Campaigns", icon: "📬" },
      ],
      color: "#a855f7",
      saved: "5–8 hrs/wk",
    },
    {
      title: "Revenue Intelligence Dashboard Agent",
      desc: "A single source of truth pulling data from Shopify, Klaviyo, Faire, Amazon, and Google Analytics — giving real-time visibility into revenue, inventory velocity, and campaign ROI across every channel. Auto-generates executive summaries and anomaly alerts.",
      before: { value: "3–5 hrs/wk", sub: "manual report pulls" },
      after: { value: "Real-time", sub: "automated dashboards" },
      flow: [
        { label: "Multi-Platform Data", icon: "🗂️" },
        { label: "AI Analytics Agent", icon: "🧠" },
        { label: "Live Dashboard & Alerts", icon: "📈" },
      ],
      color: "#ec4899",
      saved: "3–5 hrs/wk",
    },
      ...
      <section ref={heroRef} style={{
        ...
        <div style={{ position: "relative", maxWidth: 560 }}>
          ...
          <p style={{ ...tr(heroVis, 0.22), color: "#555", fontSize: 14, lineHeight: 1.7, maxWidth: 440, margin: "0 auto 20px" }}>
            Scaling a sprouted nut brand across 16,500+ retail locations with a team of ~18 means most hours go to coordination, not growth. We found {PROSPECT.automations.length} automations that could reclaim that time — worth an estimated <span style={{ color: "#fbbf24", fontWeight: 700 }}>${PROSPECT.annualCost}/year</span>.
          </p>
        ...
        <div style={{
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
              {[
                { v: 40, s: " hrs", p: "~", sub: "freed up every week" },
                { v: 450, s: "K", p: "$", sub: "in reclaimed capacity" },
