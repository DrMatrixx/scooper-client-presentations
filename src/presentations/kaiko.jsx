...
const PROSPECT = {
  name: "Mirjam",
  company: "KAIKO",
  companyDetail: "Sustainable Nordic fashion brand, founded 2016 in Helsinki",
  ...
  specifics: [
    "Founded 2016 by Mirjam Sokka — now a million-euro sustainable fashion brand selling across Europe",
    "7% of every sale funds women's education in Nepal — €134,770+ in social impact via Women's Bank partnership",
    "Production in Europe & Nepal using organic and OEKO-TEX certified cotton — carbon neutrality target set",
    "Top 3 nominee for 'Vuoden Taistelija' (Fighter of the Year) award — featured on Designkaverit Podcast",
  ],

  competitors: {
    line: "AI adoption in fashion rose from 20% to 44% in the first half of 2025",
    detail: "H&M uses AI-generated digital twins that cut campaign lead times from 6 weeks to 24 hours. Zalando's AI assistant acts as a personal stylist with smart outfit suggestions. Even smaller Nordic brands are adopting AI for personalization and content.",
    source: "McKinsey 2025",
  },

  automations: [
    {
      title: "Customer Support & Sizing Agent",
      desc: "Handles sizing questions, order inquiries, returns, and product recommendations automatically — in Finnish and English — so your small team isn't pulled away from design and strategy.",
      before: { value: "1–2 hrs/day", sub: "answering repetitive queries" },
      after: { value: "Auto-Handled", sub: "human only for edge cases" },
      flow: [
        { label: "Email & Chat Inbox", icon: "📧" },
    ...
    {
      title: "Product Content & Campaign Agent",
      desc: "Generates product descriptions, email campaigns, and social captions in KAIKO's mission-driven brand voice — across Finnish and English — so every launch moves faster without losing authenticity.",
      before: { value: "3–4 hrs", sub: "per product launch" },
      after: { value: "20 min", sub: "review & publish" },
      flow: [
        { label: "Product & Brand Data", icon: "📋" },
        { label: "AI Writing Agent", icon: "🧠" },
        { label: "Ready-to-Post Content", icon: "✍️" },
      ],
      color: "#f59e0b",
      saved: "6–12 hrs/wk",
    },
    {
      title: "Social & Community Agent",
      desc: "Monitors Instagram, Facebook, and Pinterest for brand mentions, sustainability conversations, and user-generated content — surfacing engagement opportunities your team would otherwise miss.",
      before: { value: "Manual", sub: "daily channel checks" },
      after: { value: "Real-Time", sub: "smart alerts & drafts" },
      flow: [
        { label: "Social Channels", icon: "📱" },
        { label: "AI Monitoring Agent", icon: "🔍" },
        { label: "Engagement Briefs", icon: "🔔" },
      ],
      color: "#10b981",
      saved: "4–8 hrs/wk",
    },
    {
      title: "Demand & Inventory Agent",
      desc: "Analyzes sales patterns, seasonal trends, and customer behavior to forecast demand — helping a responsible brand minimize overproduction and reduce waste, the way fashion should work.",
      before: { value: "Spreadsheets", sub: "manual trend guessing" },
      after: { value: "Smart Forecasts", sub: "data-driven planning" },
      flow: [
        { label: "Sales & Trend Data", icon: "📊" },
        { label: "AI Forecasting Agent", icon: "🧠" },
        { label: "Demand Dashboards", icon: "📈" },
      ],
      color: "#a855f7",
      saved: "3–6 hrs/wk",
    },
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 10 }}>
              {[
                ...
                { v: 10, s: "K+", p: "$", sub: "in opportunity cost", c: "#fca5a5" },
        ...
        <div style={{
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
              {[
                { v: 26, s: " hrs", p: "~", sub: "freed up every week" },
                { v: 100, s: "K", p: "$", sub: "in reclaimed capacity" },
                { v: 2, s: "–3x", p: "", sub: "more orders without new hires" },
              ].map((m, i) => (
