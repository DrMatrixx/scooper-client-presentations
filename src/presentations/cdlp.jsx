...
const PROSPECT = {
  name: "Andreas",
  company: "CDLP",
  companyDetail: "Stockholm-based luxury essentials brand, founded 2016",
  industry: "Luxury Fashion / DTC",
  teamSize: "~55",
  painNumber: "100–200",
  painPercent: "50",
  annualCost: "250K–500K",

  specifics: [
    "Stocked at Harrods, Bergdorf Goodman, MR PORTER, Selfridges — 75% revenue from DTC",
    "Raised €4.3M from Matchesfashion founder Tom Chapman and ex-Klarna exec Niklas Adalberth",
    "Pioneered Lyocell and Econyl in luxury essentials — manufactured in Italy and Portugal",
    "Grown ~100% YoY since 2016, expanding into women's and potentially skincare",
  ],

  competitors: {
    line: "73% of fashion executives now use AI in operations",
    detail: "Everlane uses AI-driven search to boost conversions. ThirdLove uses AI for size recommendations. Louis Vuitton and Burberry have deployed AI chatbots. None of CDLP's direct competitors have notable AI implementations yet.",
  ...
  automations: [
    {
      ...
      desc: "An always-on agent that handles sizing questions, product recommendations, and order inquiries across all channels — critical for a brand where fit and fabric feel drive loyalty.",
      before: { value: "3–5 min", sub: "per customer inquiry" },
      after: { value: "Instant", sub: "24/7 AI concierge" },
      flow: [
        { label: "Customer Channels", icon: "💬" },
        { label: "AI Concierge Agent", icon: "🧠" },
        { label: "Personalized Response", icon: "⚡" },
      ],
      color: "#3b82f6",
      saved: "15–25 hrs/wk",
    },
    {
      ...
      desc: "An agent that generates product descriptions, email campaigns, and social content in CDLP's distinct Scandinavian brand voice — across men's, women's, and new category launches.",
      before: { value: "2–4 hrs", sub: "per product launch" },
      after: { value: "15 min review", sub: "AI drafts in brand voice" },
      flow: [
        { label: "Product Data & Assets", icon: "📋" },
    ...
    {
      title: "Wholesale Intelligence Agent",
      desc: "Monitors sell-through performance at 30+ retail partners like MR PORTER, Harrods, and Nordstrom — surfacing reorder signals, trending styles, and inventory gaps before they become stockouts.",
      before: { value: "Manual tracking", sub: "across 30+ stockists" },
      after: { value: "Real-time alerts", sub: "AI-monitored sell-through" },
      flow: [
        { label: "Retail Partner Data", icon: "📊" },
        { label: "AI Analytics Agent", icon: "🧠" },
        { label: "Smart Alerts & Reports", icon: "📈" },
      ],
      color: "#10b981",
      saved: "10–20 hrs/wk",
    },
    {
      title: "Demand & Inventory Forecaster",
      desc: "Predicts demand across categories and markets — coordinating production planning with your Italian and Portuguese manufacturers so you never over-produce or miss a restock window.",
      before: { value: "Spreadsheet-based", sub: "seasonal forecasts" },
      after: { value: "AI-powered", sub: "rolling demand signals" },
      flow: [
        { label: "Sales & Market Data", icon: "📡" },
        { label: "AI Forecasting Agent", icon: "🧠" },
        { label: "Production Plans", icon: "⚡" },
      ],
      color: "#a855f7",
      saved: "8–15 hrs/wk",
    },
    {
      title: "Personalized Retention Agent",
      desc: "Identifies at-risk customers and triggers 1:1 re-engagement — perfectly timed replenishment nudges, size-based recommendations, and loyalty campaigns that feel personal, not batch-blasted.",
      before: { value: "Batch campaigns", sub: "same message to all" },
      after: { value: "1:1 personalization", sub: "AI-timed outreach" },
      flow: [
        { label: "Customer Behavior", icon: "📱" },
        ...
        <div style={{
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 10 }}>
              {[
                { v: 650, s: "+", p: "", sub: "hours of manual work", c: "#fca5a5" },
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
              {[
                ...
                { v: 400, s: "K", p: "$", sub: "in reclaimed capacity" },
                { v: 2, s: "–3x", p: "", sub: "more capacity without new hires" },
              ].map((m, i) => (
