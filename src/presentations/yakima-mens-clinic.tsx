      ...
      render: () => (
        <div className="text-center w-full max-w-2xl px-4">
          ...
          <p className="text-gray-500 text-xs sm:text-sm max-w-lg mx-auto">
            A strategic proposal to automate patient acquisition, follow-up, and clinical workflows — reducing administrative burden while maximizing patient care capacity.
          </p>
        </div>
      ),
    },
