...
const PROSPECT = {
  name: "Movin",
  company: "Skydo",
  companyDetail: "Cross-border payments platform, 30,000+ exporters served, $10M Series A",
  industry: "Cross-Border Payments / Fintech",
  teamSize: "~50",
  painNumber: "80–160",
  painPercent: "55",
  annualCost: "400K–1.5M",
  specifics: [
    "30,000+ exporters served across 50+ Indian cities — $300M+ processed in 32 currencies",
    "Raised $10M Series A led by Susquehanna Asia VC with Elevation Capital (Dec 2025)",
    "Among first 6 fintechs to receive final RBI PA-CB authorization",
    "Movin featured on India FinTech Diaries podcast — ex-PhonePe, IIT Delhi + IIM Ahmedabad",
  ],
  competitors: {
    line: "78% of financial services leaders report strong value from AI, driving rapid adoption",
    detail: "Wise runs 150+ AI algorithms on 7M daily transactions. Payoneer partnered with Oscilar for AI-powered fraud intelligence. Razorpay deploys AI for KYC verification and transaction optimization.",
    source: "Deloitte 2024",
  },
  automations: [
    {
      title: "Smart KYC & Compliance Agent",
      desc: "An AI agent that automates end-to-end KYC verification, monitors regulatory changes across 150+ countries, and auto-adapts compliance workflows — reducing manual review and speeding up onboarding.",
      before: { value: "2–3 Days", sub: "manual KYC per business" },
      after: { value: "Under 1 Hour", sub: "AI-verified onboarding" },
      flow: [
        { label: "KYC Documents", icon: "\u{1F4CB}" },
        { label: "AI Compliance Agent", icon: "\u{1F9E0}" },
        { label: "Verified & Approved", icon: "\u2705" },
      ],
      color: "#3b82f6",
      saved: "15–25 hrs/wk",
    },
    {
      title: "Real-Time Fraud Detection Agent",
      desc: "An AI agent that monitors every inbound transaction in real time, flags suspicious patterns, and auto-escalates high-risk cases — protecting 30,000+ businesses while reducing false positives.",
      before: { value: "Manual Review", sub: "delayed flagging of issues" },
      after: { value: "Real-Time", sub: "instant risk scoring" },
      flow: [
        { label: "Transaction Stream", icon: "\u{1F4E1}" },
        { label: "AI Fraud Agent", icon: "\u{1F9E0}" },
        { label: "Risk Score & Alert", icon: "\u{1F514}" },
      ],
      color: "#f59e0b",
      saved: "10–20 hrs/wk",
    },
    {
      ...
      desc: "An AI agent that resolves payment status queries, FIRA requests, fee questions, and onboarding help across WhatsApp, email, and chat — escalating only complex cases to human agents.",
      before: { value: "2-Hour SLA", sub: "manual response each query" },
      after: { value: "Instant", sub: "AI resolves 70%+ queries" },
      flow: [
        { label: "Support Channels", icon: "\u{1F4AC}" },
        { label: "AI Support Agent", icon: "\u{1F9E0}" },
        { label: "Resolution or Escalation", icon: "\u26A1" },
      ],
      color: "#10b981",
      saved: "15–25 hrs/wk",
    },
    {
      title: "Smart Payment Routing Agent",
      desc: "An AI agent that analyzes real-time FX rates across banking partners, selects optimal routing for each transaction across 32 currencies, and predicts rate movements — maximizing value per transfer.",
      before: { value: "Fixed Routes", sub: "static bank per corridor" },
      after: { value: "Dynamic Routing", sub: "AI-optimized per txn" },
      flow: [
        { label: "FX & Bank Data", icon: "\u{1F4CA}" },
        { label: "AI Routing Agent", icon: "\u{1F9E0}" },
        { label: "Optimal Path Selected", icon: "\u{1F3AF}" },
      ],
      color: "#a855f7",
      saved: "5–10 hrs/wk",
    },
    {
      title: "Exporter Intelligence Agent",
      desc: "An AI agent that analyzes transaction patterns across 30,000+ exporters, surfaces growth opportunities, and delivers personalized payment insights — turning data into strategic advantage.",
      before: { value: "None", sub: "no proactive insights" },
      after: { value: "Weekly Briefs", sub: "AI-generated recommendations" },
      flow: [
        { label: "Transaction History", icon: "\u{1F5C2}\uFE0F" },
        { label: "AI Insights Agent", icon: "\u{1F9E0}" },
        { label: "Growth Recommendations", icon: "\u{1F4C8}" },
      ],
      color: "#ec4899",
      saved: "5–10 hrs/wk",
    },
          ...
          <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, alignItems: "start" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
              ...
              <div style={{
                ...
                <span style={{ fontSize: 11, fontWeight: 700, color: c }}>{"\u{1F550}"} {a.saved} saved</span>
              </div>
            </div>
          </div>
        </div>
    ...
    <div style={{ minHeight: "100vh", background: "#08080e", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', system-ui, sans-serif", color: "#fff", overflowX: "hidden" }}>
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 10 }}>
              {[
                ...
                { v: 80, s: "K+", p: "$", sub: "in opportunity cost", c: "#fca5a5" },
            ...
            <p style={{ color: "#555", fontSize: 11, marginTop: 16, lineHeight: 1.5 }}>
              AI systems improve with data. Fintechs that start building this advantage now will be increasingly difficult to catch.
            </p>
          </div>
        </div>
      </section>
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
              {[
                ...
                { v: 500, s: "K", p: "$", sub: "in reclaimed capacity" },
                { v: 2, s: "\u20133x", p: "", sub: "more scale without new hires" },
              ].map((m, i) => (
      ...
      <section ref={ctaRef} style={{ padding: "20px 16px 100px", maxWidth: 540, margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: 40 }}>
          {[
            { icon: "\u{1F4AC}", t: "You describe it", d: "A workflow, a pain point, an idea." },
            { icon: "\u26A1", t: "We build it custom", d: "Not templates. Engineered for your team." },
            { icon: "\u{1F504}", t: "It runs for you", d: "Deployed, monitored, continuously improved." },
          ].map((s, i) => (
            <div key={i} style={{
