...
const PROSPECT = {
  ...
  companyDetail: "100% Made-in-France underwear & clothing brand, €21M revenue, 30+ partner ateliers",
  industry: "Fashion & Textile Manufacturing",
  teamSize: "~100",
  painNumber: "120–250",
  painPercent: "55",
  annualCost: "250K–600K",

  specifics: [
    "100% Made in France — 30+ partner ateliers, 200+ workers, all within 250 km of Paris",
    "€21M revenue in 2025 (+16% YoY) — first year of profitability after bold 'Révolution' pivot",
    "800K lifetime customers, 200K new in 2025 — Shopify Plus + 600 mass retail partner locations",
    "New 'La Belle Paire' sock atelier with Broussaud Textiles — targeting 400K pairs/year",
  ],

  competitors: {
    line: "AI in apparel could unlock $275B in additional operating profit",
    detail: "LVMH runs a centralized AI team across all brands. Zara uses AI for real-time demand forecasting. Petit Bateau and Sézane are investing in AI-powered supply chain tools.",
  ...
  automations: [
    {
      ...
      desc: "An AI agent that handles sizing questions, order tracking, returns, and product inquiries across channels — for 800K+ customers and 200K new ones every year, in both French and English.",
      before: { value: "4–6 hrs/day", sub: "manual replies across channels" },
      after: { value: "Minutes", sub: "AI resolves 70%+ instantly" },
      flow: [
        { label: "Customer Inquiries", icon: "💬" },
        { label: "AI Support Agent", icon: "🧠" },
        { label: "Resolved or Escalated", icon: "✅" },
      ],
      color: "#3b82f6",
      saved: "15–25 hrs/wk",
    },
    {
      ...
      desc: "Real-time inventory sync across Shopify, your owned stores, and 600+ Carrefour/E.Leclerc/Intermarché locations — with AI-powered demand forecasting by SKU, channel, and season.",
      before: { value: "Spreadsheets", sub: "manual stock checks & guesswork" },
      after: { value: "Real-time", sub: "AI-predicted demand by channel" },
      flow: [
        { label: "Sales & Stock Data", icon: "📊" },
        { label: "AI Forecast Agent", icon: "🧠" },
        { label: "Reorder Alerts", icon: "🔔" },
      ],
      color: "#f59e0b",
      saved: "10–20 hrs/wk",
    },
    {
      title: "Manufacturing Order Agent",
      desc: "Automatically generates and routes manufacturing orders to the optimal atelier based on capacity, capabilities, and deadlines — across your 30+ partner workshops from Bonne Nouvelle to La Belle Paire.",
      before: { value: "Manual / Hours", sub: "MO creation & routing" },
      after: { value: "Auto-generated", sub: "optimal atelier matching" },
      flow: [
        { label: "Demand Signals", icon: "📋" },
        { label: "AI Planning Agent", icon: "🧠" },
        { label: "MOs to Ateliers", icon: "⚡" },
      ],
      color: "#10b981",
      saved: "12–20 hrs/wk",
    },
    {
      title: "Procurement & PO Automation",
      desc: "AI monitors raw material levels — cotton, linen, packaging — and auto-generates purchase orders to suppliers when stock hits reorder points, coordinating lead times with your production calendar.",
      before: { value: "Manual tracking", sub: "PO creation by hand" },
      after: { value: "Auto-triggered POs", sub: "smart lead time planning" },
      flow: [
        { label: "Material Levels", icon: "🗂️" },
        { label: "AI Sourcing Agent", icon: "🧠" },
        { label: "POs to Suppliers", icon: "📬" },
      ],
      color: "#a855f7",
      saved: "8–15 hrs/wk",
    },
    {
      title: "Seasonal Production Planner",
      desc: "An AI agent that analyzes seasonal patterns — Christmas, Father's Day, Black Friday, swimwear season — alongside channel-specific demand to generate optimized production schedules across all ateliers.",
      before: { value: "Weeks", sub: "seasonal forecasting cycle" },
      after: { value: "Continuous", sub: "AI-driven production plans" },
      flow: [
        { label: "Trends & History", icon: "📈" },
        { label: "AI Planning Agent", icon: "🧠" },
        { label: "Production Schedules", icon: "📄" },
      ],
      color: "#ec4899",
      saved: "8–12 hrs/wk",
    },
        ...
        <div style={{
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 10 }}>
              {[
                { v: 800, s: "+", p: "", sub: "hours of manual work", c: "#fca5a5" },
          ...
          <div style={{ position: "relative" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: 12 }}>
              {[
                ...
                { v: 270, s: "K", p: "€", sub: "in reclaimed capacity" },
                { v: 1.5, s: "–2x", p: "", sub: "more growth without new hires" },
              ].map((m, i) => (
