...
const presentation: PresentationConfig = {
  title: 'Prismatics',
  description: 'Operational Transformation Through Intelligent Automation — AI Proposal for Prismatics',
  slides: [
    // Slide 1: Title
    {
      id: 'title',
      render: () => (
        <div className="text-center w-full max-w-3xl px-4">
          ...
          <div className="mb-5 sm:mb-6 animate-fade-in-up animation-delay-200">
            <p className="text-gray-400 text-base sm:text-lg mb-2">What if your team could reclaim</p>
            ...
            <p className="text-gray-400 text-sm sm:text-base mt-1">worth $300K–$450K annually in recovered capacity?</p>
          </div>

          <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-6 sm:mb-8 max-w-xl mx-auto animate-fade-in-up animation-delay-300">
            {[
              { value: '56 hrs', label: 'Weekly manual reporting', icon: FileText },
              { value: '32%', label: 'Senior billable utilization', icon: Clock },
              { value: '20-30%', label: 'Media list decay/year', icon: Users },
            ].map((item, i) => (
          ...
          <div className="relative max-w-lg mx-auto mb-6 sm:mb-8 animate-fade-in-up animation-delay-400">
            ...
            <div className="relative glass bg-gray-950/80 rounded-2xl p-4 sm:p-5 border border-emerald-500/30">
              ...
              <p className="text-gray-300 text-sm sm:text-base leading-relaxed">
                5 custom automations to cut reporting time by <span className="text-white font-bold">80%+</span>, match media with <span className="text-white font-bold">2-3x better targeting</span>, and give your team back <span className="text-white font-bold">75+ hours every week</span>
              </p>
            </div>
          </div>
    ...
    // Slide 2: Current Reality
    {
      ...
      render: () => {
        const tasks = [
          { task: 'Media monitoring & coverage tracking', time: '2-3 hrs/day', issue: 'Delayed response to opportunities' },
          { task: 'Client reporting & status updates', time: '4-6 hrs/wk/client', issue: 'Time away from strategic work' },
          { task: 'Media list research & maintenance', time: '1-2 hrs/day', issue: 'Lists decay 20-30% annually' },
          { task: 'Pitch personalization & follow-ups', time: '2-3 hrs/day', issue: 'Generic outreach = lower response' },
          { task: 'Client onboarding documentation', time: '3-5 hrs/client', issue: 'Delayed campaign launch' },
          { task: 'Competitive intelligence gathering', time: '1-2 hrs/day', issue: 'Reactive instead of proactive' },
        ];
          ...
          <div className="w-full max-w-3xl px-4 relative">
            ...
            <div className="bg-white/5 rounded-xl sm:rounded-2xl border border-white/10 p-4 sm:p-6 mb-4 sm:mb-5">
              <p className="text-gray-300 text-sm sm:text-base mb-4 sm:mb-5">
                PR agencies in health, wellness, beauty, and beverage face unique demands. Your team juggles creative strategy with repetitive admin tasks that consume valuable hours every day.
              </p>
    ...
    // Slide 3: Cost of Problem
    {
      ...
      render: () => {
        const metrics = [
          { icon: FileText, value: '56 hrs/wk', metric: 'Manual Reporting', desc: 'Wasted on data entry (Agorapulse)' },
          { icon: Mail, value: '100-200', metric: 'Pitches/Day to Journalists', desc: 'Your pitch competes for milliseconds' },
          { icon: Users, value: '20-30%', metric: 'Media List Decay', desc: 'Contacts change annually' },
          { icon: Clock, value: '32%', metric: 'Senior Utilization', desc: 'Billable capacity (PRSA)' },
        ];
          ...
          <div className="w-full max-w-3xl px-4 relative">
            ...
            <div className="bg-rose-500/10 rounded-lg sm:rounded-xl border border-rose-500/20 p-3 sm:p-4 text-center">
              <p className="text-rose-400 text-xs sm:text-sm">
                Estimate: <span className="text-white font-bold">$75K-$150K/year</span> in lost productivity, missed opportunities, and inefficiencies
              </p>
            </div>
          </div>
        );
    ...
    // Slide 4: Opportunity
    {
      ...
      render: () => {
        const todayItems = [
          'Manual media list building in spreadsheets',
          'Hours compiling weekly client reports',
          'Generic pitch templates to broad lists',
          'Reactive media monitoring',
          'Scattered competitive intel',
        ];
        const automatedItems = [
          'AI-curated journalist lists updated in real-time',
          'Auto-generated coverage summaries in minutes',
          'Personalized pitches matched to journalist prefs',
          'Smart alerts for coverage opportunities',
          'Automated competitor tracking & insights',
        ];
        const summaryMetrics = [
          { icon: Clock, metric: '75+ hrs', label: 'Saved/Week' },
          { icon: Target, metric: '2-3x', label: 'Pitch Response' },
          { icon: Sparkles, metric: '24/7', label: 'Monitoring' },
        ];
    ...
    // Slide 5: Solution Overview
    {
      ...
      render: () => {
        const automations = [
          { num: '01', title: 'Onboarding Engine', desc: 'One-click client setup', icon: FileText },
          { num: '02', title: 'Media Matching', desc: 'AI journalist targeting', icon: Search },
          { num: '03', title: 'Coverage Alerts', desc: '24/7 smart monitoring', icon: Bell },
          { num: '04', title: 'Auto Reporting', desc: 'Client-ready reports', icon: BarChart3 },
          { num: '05', title: 'Pitch Generator', desc: 'AI-crafted angles', icon: PenTool },
        ];
        ...
        return (
          <div className="w-full max-w-3xl px-4 relative">
            ...
            <div className="mt-4 sm:mt-6 text-center">
              <p className="text-gray-400 text-xs sm:text-sm">
                Each automation is custom-built for Prismatics' workflows and the unique needs of health, wellness, beauty, and beverage brands.
              </p>
            </div>
          </div>
        );
    ...
    // Slide 6: Automation 1 - Client Onboarding Engine
    {
      id: 'auto1',
      render: () => {
        const capabilities = [
          'Auto-populates client intake data into templated documents',
          'Generates brand positioning one-pagers from website/materials',
          'Creates spokesperson bio variations (100-word, 250-word, full)',
          'Produces media briefing sheets with talking points',
          'Syncs all docs to shared folders and project management tools',
        ];
          ...
          <div className="w-full max-w-3xl px-4 relative">
            ...
            <div className="bg-white/5 rounded-xl sm:rounded-2xl border border-white/10 p-4 sm:p-5 mb-3 sm:mb-4">
              <p className="text-gray-300 text-sm sm:text-base mb-3 sm:mb-4">
                Automatically generates comprehensive onboarding packages when a new client signs — brand positioning summaries, spokesperson bios, key messaging frameworks, and media briefing materials.
              </p>
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-4 mb-3 sm:mb-4">
                <div className="p-3 sm:p-4 bg-rose-500/10 rounded-lg sm:rounded-xl border border-rose-500/20 text-center">
                  ...
                  <p className="text-gray-500 text-xs">Per new client</p>
                </div>
                <div className="p-3 sm:p-4 bg-emerald-500/10 rounded-lg sm:rounded-xl border border-emerald-500/20 text-center">
                  ...
                  <p className="text-gray-500 text-xs">One-click generation</p>
                </div>
              </div>
            ...
            <div className="bg-amber-500/10 rounded-lg sm:rounded-xl border border-amber-500/20 p-2 sm:p-3 text-center">
              <p className="text-amber-400 text-xs sm:text-sm">
                <span className="font-bold">Impact:</span> Campaign setup time reduced by 80%, faster time-to-first-pitch
              </p>
            </div>
          </div>
        );
    ...
    // Slide 7: Automation 2 - Intelligent Media Matching
    {
      id: 'auto2',
      render: () => {
        const capabilities = [
          'Monitors journalist beats, recent articles, and topics of interest',
          'Identifies podcast guest opportunities based on client expertise',
          'Flags journalists who recently covered competitors or adjacent brands',
          'Surfaces trending stories where clients can contribute commentary',
          'Prioritizes opportunities by relevance score and outlet authority',
        ];
          ...
          <div className="w-full max-w-3xl px-4 relative">
            ...
            <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-5">
              ...
              <div>
                ...
                <h2 className="text-xl sm:text-2xl font-bold text-white">Intelligent Media Matching</h2>
              </div>
            </div>

            <div className="bg-white/5 rounded-xl sm:rounded-2xl border border-white/10 p-4 sm:p-5 mb-3 sm:mb-4">
              <p className="text-gray-300 text-sm sm:text-base mb-3 sm:mb-4">
                Continuously scans journalist databases, recent coverage, and social activity to match your clients with the most relevant media opportunities — podcasts, journalists, publications, and trend stories.
              </p>
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-4 mb-3 sm:mb-4">
                <div className="p-3 sm:p-4 bg-rose-500/10 rounded-lg sm:rounded-xl border border-rose-500/20 text-center">
                  ...
                  <p className="text-gray-500 text-xs">Manual research</p>
                </div>
                <div className="p-3 sm:p-4 bg-emerald-500/10 rounded-lg sm:rounded-xl border border-emerald-500/20 text-center">
                  <p className="text-emerald-400 text-xs mb-1">After</p>
                  <p className="text-white text-xl sm:text-2xl font-bold">Always-On</p>
                  <p className="text-gray-500 text-xs">Hyper-targeted matching</p>
                </div>
              </div>
            ...
            <div className="bg-amber-500/10 rounded-lg sm:rounded-xl border border-amber-500/20 p-2 sm:p-3 text-center">
              <p className="text-amber-400 text-xs sm:text-sm">
                <span className="font-bold">Impact:</span> Pitch response rates improve 2-3x with precise, timely targeting
              </p>
            </div>
          </div>
        );
    ...
    // Slide 8: Automation 3 - Smart Coverage Alerts
    {
      id: 'auto3',
      render: () => {
        const capabilities = [
          'Monitors client brand mentions across digital, print, and broadcast',
          'Tracks competitor coverage and messaging positioning',
          'Alerts on trending industry topics (wellness, ingredients, lifestyle shifts)',
          'Identifies sentiment shifts and potential reputation issues',
          'Delivers daily/weekly digest summaries to teams and clients',
        ];
        ...
        return (
          <div className="w-full max-w-3xl px-4 relative">
            ...
            <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-5">
              <div className="w-8 h-8 sm:w-10 sm:h-10 rounded-lg bg-amber-500/20 flex items-center justify-center">
                <Bell size={16} className="text-amber-400 sm:w-5 sm:h-5" />
              </div>
              <div>
                <p className="text-amber-400 text-xs">Automation 03</p>
                <h2 className="text-xl sm:text-2xl font-bold text-white">Smart Coverage Alerts</h2>
              </div>
            </div>

            <div className="bg-white/5 rounded-xl sm:rounded-2xl border border-white/10 p-4 sm:p-5 mb-3 sm:mb-4">
              <p className="text-gray-300 text-sm sm:text-base mb-3 sm:mb-4">
                24/7 monitoring across news, social, podcasts, and newsletters — with AI-filtered alerts that surface only what matters: client mentions, competitor moves, trending topics, and media opportunities.
              </p>
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-4 mb-3 sm:mb-4">
                <div className="p-3 sm:p-4 bg-rose-500/10 rounded-lg sm:rounded-xl border border-rose-500/20 text-center">
                  ...
                  <p className="text-gray-500 text-xs">Delayed discovery</p>
                </div>
                <div className="p-3 sm:p-4 bg-emerald-500/10 rounded-lg sm:rounded-xl border border-emerald-500/20 text-center">
                  <p className="text-emerald-400 text-xs mb-1">After</p>
                  <p className="text-white text-xl sm:text-2xl font-bold">Real-Time</p>
                  <p className="text-gray-500 text-xs">Instant notifications</p>
                </div>
              </div>
            ...
            <div className="bg-amber-500/10 rounded-lg sm:rounded-xl border border-amber-500/20 p-2 sm:p-3 text-center">
              <p className="text-amber-400 text-xs sm:text-sm">
                <span className="font-bold">Impact:</span> Never miss a coverage opportunity or emerging crisis — respond in hours, not days
              </p>
            </div>
          </div>
        );
    ...
    // Slide 9: Automation 4 - Automated Client Reporting
    {
      id: 'auto4',
      render: () => {
        const capabilities = [
          'Auto-aggregates all media placements with links, reach, and sentiment',
          'Calculates share of voice vs. competitors',
          'Generates executive summaries with key highlights',
          'Includes visual charts: coverage timeline, outlet breakdown, sentiment trends',
          'Exports to PDF or client dashboard with one click',
        ];
          ...
          <div className="w-full max-w-3xl px-4 relative">
            ...
            <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-5">
              ...
              <div>
                ...
                <h2 className="text-xl sm:text-2xl font-bold text-white">Automated Client Reporting</h2>
              </div>
            </div>

            <div className="bg-white/5 rounded-xl sm:rounded-2xl border border-white/10 p-4 sm:p-5 mb-3 sm:mb-4">
              <p className="text-gray-300 text-sm sm:text-base mb-3 sm:mb-4">
                Pulls coverage data, media metrics, and campaign activity into polished, client-ready reports — weekly summaries or monthly deep-dives — without manual data entry or formatting.
              </p>
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-4 mb-3 sm:mb-4">
                <div className="p-3 sm:p-4 bg-rose-500/10 rounded-lg sm:rounded-xl border border-rose-500/20 text-center">
                  ...
                  <p className="text-gray-500 text-xs">Per client</p>
                </div>
                <div className="p-3 sm:p-4 bg-emerald-500/10 rounded-lg sm:rounded-xl border border-emerald-500/20 text-center">
                  <p className="text-emerald-400 text-xs mb-1">After</p>
            ...
            <div className="bg-amber-500/10 rounded-lg sm:rounded-xl border border-amber-500/20 p-2 sm:p-3 text-center">
              <p className="text-amber-400 text-xs sm:text-sm">
                <span className="font-bold">Impact:</span> Reclaim 15-25 hours/week while delivering more consistent, professional reporting
              </p>
            </div>
          </div>
        );
    ...
    // Slide 10: Automation 5 - Pitch Angle Generator
    {
      id: 'auto5',
      render: () => {
        const capabilities = [
          'Generates 3-5 distinct pitch angles from a single brief',
          'Creates variations for: trade press, mainstream, podcasts, newsletters',
          'Suggests subject lines based on journalist engagement data',
          'Incorporates trending hooks and timely news angles',
          ...
          <div className="w-full max-w-3xl px-4 relative">
            ...
            <div className="flex items-center gap-2 sm:gap-3 mb-4 sm:mb-5">
              ...
              <div>
                ...
                <h2 className="text-xl sm:text-2xl font-bold text-white">Pitch Angle Generator</h2>
              </div>
            </div>

            <div className="bg-white/5 rounded-xl sm:rounded-2xl border border-white/10 p-4 sm:p-5 mb-3 sm:mb-4">
              <p className="text-gray-300 text-sm sm:text-base mb-3 sm:mb-4">
                Given a client brief, trending news, or announcement, AI generates multiple pitch angles tailored to different journalist types, beats, and outlet formats — with optimized subject lines and opening hooks.
              </p>
              ...
              <div className="grid grid-cols-2 gap-2 sm:gap-4 mb-3 sm:mb-4">
                <div className="p-3 sm:p-4 bg-rose-500/10 rounded-lg sm:rounded-xl border border-rose-500/20 text-center">
                  ...
                  <p className="text-gray-500 text-xs">Brainstorming angles</p>
                </div>
                <div className="p-3 sm:p-4 bg-emerald-500/10 rounded-lg sm:rounded-xl border border-emerald-500/20 text-center">
                  <p className="text-emerald-400 text-xs mb-1">After</p>
                  <p className="text-white text-xl sm:text-2xl font-bold">Minutes</p>
                  <p className="text-gray-500 text-xs">Multiple angles ready</p>
                </div>
              </div>
            ...
            <div className="bg-amber-500/10 rounded-lg sm:rounded-xl border border-amber-500/20 p-2 sm:p-3 text-center">
              <p className="text-amber-400 text-xs sm:text-sm">
                <span className="font-bold">Impact:</span> More pitches, faster — without sacrificing personalization or strategic thinking
              </p>
            </div>
          </div>
        );
    ...
    // Slide 11: Industry Context
    {
      ...
      render: () => {
        const factors = [
          { title: 'Trend-Driven Categories', desc: 'Smart alerts track emerging trends, ingredient stories, and cultural moments', icon: TrendingUp },
          { title: 'High-Volume Media', desc: 'Intelligent matching cuts through noise to find the right journalists', icon: Search },
          { title: 'Competitive DTC Market', desc: 'Competitive tracking surfaces market movements and positioning shifts', icon: Target },
          { title: 'Trust & Authenticity', desc: 'Sentiment monitoring catches tone issues before they escalate', icon: CheckCircle },
        ];
        ...
        return (
          <div className="w-full max-w-3xl px-4 relative">
            ...
            <h2 className="text-2xl sm:text-3xl font-bold text-white mb-4 sm:mb-6">
              Built for <GradientText>Health, Wellness, Beauty & Beverage</GradientText>
            </h2>

            <div className="bg-white/5 rounded-xl sm:rounded-2xl border border-white/10 p-4 sm:p-6 mb-4 sm:mb-5">
              <p className="text-gray-300 text-sm sm:text-base mb-4 sm:mb-5">
                Prismatics operates at the intersection of emerging culture and consumer brands. These automations are designed with your industry's specific needs in mind.
              </p>

              <div className="grid grid-cols-2 gap-2 sm:gap-4">
                {factors.map((item, i) => (
                  <div key={i} className="p-3 sm:p-4 bg-white/5 rounded-lg sm:rounded-xl border border-white/10">
                    <div className="flex items-center gap-2 mb-2">
                      <item.icon size={14} className="text-amber-400 sm:w-[16px] sm:h-[16px]" />
            ...
            <div className="text-center">
              <p className="text-gray-400 text-xs sm:text-sm">
                Multi-channel coverage monitoring spans lifestyle, trade, podcasts, newsletters, and social.
              </p>
            </div>
          </div>
        );
    ...
    // Slide 12: Expected Results
    {
      ...
      render: () => {
        const results = [
          { icon: BarChart3, metric: 'Reporting Time', before: '4-6 hrs/client/wk', after: 'Under 1 hour' },
          { icon: Search, metric: 'Media Research', before: '1-2 hrs/day manual', after: 'Continuous AI matching' },
          { icon: FileText, metric: 'Onboarding Time', before: '3-5 hours/client', after: '15-30 minutes' },
          { icon: Bell, metric: 'Coverage Response', before: 'Hours to days', after: 'Real-time alerts' },
        ];
          ...
          <div className="w-full max-w-3xl px-4 relative">
            ...
            <div className="bg-gradient-to-r from-amber-500/10 to-orange-500/10 rounded-lg sm:rounded-xl border border-amber-500/20 p-3 sm:p-4 text-center">
              <p className="text-white text-sm sm:text-lg font-semibold">
                Annual Value: <span className="text-amber-400">$300K-$450K</span>
              </p>
              <p className="text-gray-500 text-xs sm:text-sm">75+ hours saved per week across the team (3,900+ hours annually)</p>
            </div>
          </div>
        );
      },
        ...
        const phases = [
          {
            ...
            time: 'Weeks 1-4',
            status: 'Quick Wins',
            items: ['CRM & workflow audit', 'Onboarding Engine', 'Core integrations (GWS, Slack, PM)'],
          },
          {
            title: 'Automation',
            time: 'Weeks 5-8',
            status: 'Core System',
            items: ['Smart Coverage Alerts', 'Auto Client Reporting', 'Media Matching engine'],
          },
          {
            title: 'Intelligence',
            time: 'Weeks 9-12',
            status: 'Full Operation',
            items: ['Pitch Angle Generator', 'Dashboard refinement', 'Team training & adoption'],
          },
        ];
      ...
      render: () => (
        <div className="text-center w-full max-w-2xl px-4">
          ...
          <p className="text-gray-400 text-sm sm:text-base mb-6 sm:mb-8 max-w-lg mx-auto">
            Let's discuss how these automations can work specifically for Prismatics.
          ...
          <div className="grid grid-cols-3 gap-2 sm:gap-4 mb-6 sm:mb-8">
            {[
              ...
              { value: '75+ hrs', label: 'Saved weekly' },
